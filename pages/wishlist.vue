        ...
        <div class="cart-main-area pt-90 pb-100">
            <div class="container">
                <div class="row" v-if="products.length > 0">
                    <div class="col-12">
                        <h3 class="cart-page-title">Sevimlilar roʻyxati</h3>
                                ...
                                <tbody>
                                    <tr v-for="(product, index) in products" :key="index">
                                        ...
                                        <td class="product-price-cart">
                                            <span class="amount">{{ discountedPrice(product).toFixed(2) }} so'm</span>
                                            <del class="old" v-if="product.discount > 0">${{ product.price.toFixed(2) }}</del>
                                        </td>
                                        <td class="product-wishlist-cart">
                                            <button @click="addToCart(product)">Savatga qo'shish</button>
                                        </td>
                ...
                <div class="row" v-else>
                    <div class="col-12">
                        <div class="empty-cart text-center">
                            ...
                            <h4>Sevimlilar roʻyxati boʻsh</h4>
                            <n-link to="/shop" class="empty-cart__button">Yangi qo'shish</n-link>
                        </div>
                    </div>
                </div>
            </div>
