                    ...
                    <div class="product-details-slider">
                        <div class="product-details-img">
                            <div class="product-badges">
                                <span class="product-label pink" v-if="product.new">Zo'r narx</span>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product-details-content ml-70">
                        ...
                        <div class="product-details-price">
                            <span>{{ discountedPrice(product).toFixed(2) }} so'm</span>
                            <span class="old" v-if="product.discount > 0">{{ product.price.toFixed(2) }} so'm</span>
                        </div>
