<template>
    <div>
        <header class="header-area sticky-bar header-padding-3 header-res-padding header-ptb-hm5 transparent-bar" :class="{'is-sticky': isSticky}">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-4">
                        <div class="logo text-center logo-hm5">
                            <n-link to="/" class="sticky-none">
                                <img src="https://texnomart.uz/_nuxt/img/texnomart-logo.a75bf76.svg" alt="brand logo">
                            </n-link>
